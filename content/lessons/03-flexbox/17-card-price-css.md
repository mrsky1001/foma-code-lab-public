...
Вложенный `span` (текст «/ час») стилизуем отдельно:
- Меньший размер шрифта (13px)
- Нормальный вес (не жирный)
- Серый цвет — второстепенная информация
...
```css
.card-price {
  font-size: 18px;   /* крупная цена — главный акцент card-footer */
  font-weight: 700;  /* жирный */
  color: #222222;    /* почти чёрный */
}

.card-price span {
  font-size: 13px;   /* единица «/ час» — мельче основной цены */
  font-weight: 400;  /* нормальный вес */
  color: #666666;    /* серый — вторичная информация */
}
```
