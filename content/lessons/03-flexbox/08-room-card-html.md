...
Структура карточки состоит из двух частей:

```
div.room-card
  ├── div.card-img-wrap   ← фото (добавим следующим шагом)
  └── div.card-content    ← текст и кнопки
```

Принцип: сначала создаём пустой контейнер, потом заполняем.

## 🛠 Задание

Внутри `div.rooms-grid` добавьте первую карточку:
```html
<!-- Карточка комнаты: обёртка + блок картинки + блок с текстом -->
<div class="room-card">
  <div class="card-img-wrap">
    <!-- Сюда поместим фото комнаты -->
  </div>
  <div class="card-content">
    <!-- Сюда поместим заголовок, параметры и кнопки -->
  </div>
</div>
```
