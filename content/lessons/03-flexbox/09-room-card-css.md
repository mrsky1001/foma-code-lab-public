---
title: "CSS карточки комнаты"
highlight: css
type: practice
---

# CSS карточки комнаты

Стилизуем карточку:
- `width: 373px` — фиксированная ширина (при flex-wrap 3 карточки по 373px + 2 gap по 20px = 1200px)
- `border-radius: 6px` + `overflow: hidden` — углы карточки скруглятся, и картинка тоже
- `display: flex; flex-direction: column` — чтобы card-content мог тянуться вниз

## 🛠 Задание

Добавьте стили карточки:
```css
.room-card {
  width: 373px;              /* фиксированная ширина: 3 карточки + 2 gap = 1200px */
  border: 1px solid #dddddd; /* тонкая рамка вокруг карточки */
  border-radius: 6px;        /* скруглить углы карточки */
  overflow: hidden;          /* обрезает картинку по скруглённым углам */
  background-color: #ffffff; /* белый фон */
  display: flex;             /* колонка для вертикальной компоновки */
