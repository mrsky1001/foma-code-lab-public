---
title: "Секция популярных комнат"
highlight: html
type: practice
---

# Секция популярных комнат

Добавляем новую секцию под Hero-блоком. Она будет содержать каталог из 3 популярных комнат.

`<section>` — семантический блок. Тег говорит браузеру и поисковику: здесь самостоятельная, логически законченная часть страницы.

Внутри:
- `<h2>` — заголовок второго уровня (после `<h1>` в Hero)
- `<p>` — подзаголовок-описание

## 🛠 Задание

После `</section>` Hero-блока добавьте:
```html
<!-- Секция популярных комнат каталога -->
<section class="popular-section">
  <h2 class="page-title">Популярные офисные комнаты</h2> <!-- заголовок секции -->
  <p class="page-subtitle">Наиболее востребованные пространства с полным техническим оснащением</p> <!-- поясняющий подзаголовок -->
</section>
```
