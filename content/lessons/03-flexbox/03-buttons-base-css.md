---
title: "Базовый класс кнопок .btn"
highlight: css
type: practice
---


# Базовый класс кнопок .btn

Компонент кнопки строится по слоям:

1. **Базовый класс `.btn`** — общие свойства: размер, скругление, шрифт
2. **Модификаторы** (`.btn-primary`, `.btn-outline`) — конкретный цвет

Это называется **BEM-подход**: один базовый + один модификатор.

`display: inline-block` позволяет задавать ширину/высоту для ссылки.

## 🛠 Задание

Добавьте базовые стили кнопки:
```css
.btn {
  display: inline-block;       /* позволяет задавать ширину и отступы ссылке */
  padding: 8px 16px;           /* внутренние отступы: 8px сверху/снизу, 16px по бокам */
  font-size: 14px;             /* размер текста кнопки */
  font-weight: 600;            /* полужирный текст */
  border-radius: 4px;          /* слегка скруглить углы */
  border: 1px solid transparent; /* рамка прозрачная — перезаписывается модификатором */
  cursor: pointer;             /* курсор-рука при наведении */
  text-decoration: none;       /* убрать подчёркивание у ссылки-кнопки */
