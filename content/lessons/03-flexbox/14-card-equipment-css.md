---
title: "CSS списка оснащения"
highlight: css
type: practice
---


# CSS списка оснащения

`.card-equipment { flex: 1 }` — ещё один трюк. Список оснащения занимает всё свободное место между заголовком и footer-ом карточки.

`list-style: none` убирает стандартные точки.

Светлый цвет текста `#555555` для второстепенной информации — визуальная иерархия.

## 🛠 Задание

Добавьте стили списка оснащения:
```css
.card-equipment {
  list-style: none;    /* убрать стандартные маркеры-точки */
  margin-bottom: 15px; /* отступ до card-footer */
  flex: 1;             /* занять всё место между заголовком и footer */
}

.card-equipment li {
  font-size: 13px;     /* мелкий текст для вторичной информации */
  color: #555555;      /* серый — не перебивает заголовок */
