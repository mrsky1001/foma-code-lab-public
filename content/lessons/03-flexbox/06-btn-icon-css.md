---
title: "Кнопка-иконка .btn-icon"
highlight: css
type: practice
---

# Кнопка-иконка .btn-icon

Квадратная кнопка только с иконкой — компактная ссылка на детальную страницу комнаты.

`display: inline-flex` с `align-items: center` + `justify-content: center` — удобный способ выровнять SVG-иконку по центру.

`width: 36px; height: 36px` — фиксированный квадрат.

## 🛠 Задание

Добавьте стили кнопки-иконки:
```css
.btn-icon {
  display: inline-flex;        /* flex чтобы центрировать SVG-иконку внутри */
  align-items: center;         /* выровнять иконку по вертикали */
  justify-content: center;     /* выровнять иконку по горизонтали */
  width: 36px;                 /* фиксированная ширина квадратной кнопки */
  height: 36px;                /* фиксированная высота */
  padding: 0;                  /* без внутренних отступов — только иконка */
...
.btn-icon:hover {
  ...
  color: #0056b3;              /* темнее синий цвет иконки */
  border-color: #0056b3;       /* темнее рамка */
}
```
