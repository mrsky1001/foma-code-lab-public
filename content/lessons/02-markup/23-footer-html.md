...
`<footer>` — семантический тег подвала. Здесь размещают: копирайт, контакты, ссылки.

Структура:
```
footer.footer
  └── div.container.footer-container
        ├── div.footer-info (текст о компании)
        └── div.footer-contacts (контакты)
```

`<strong>` — выделяет текст жирным (семантически «важный» текст).

## 🛠 Задание

После `</main>` добавьте footer:
```html
<footer class="footer">           <!-- семантический подвал сайта -->
  <div class="container footer-container">  <!-- контейнер: ограничивает ширину, Flexbox -->
    <div class="footer-info">    <!-- левая часть: описание компании -->
      <p><strong>СмартОфис</strong> — Сервис бронирования офисных комнат</p>
      <!-- strong — жирный + семантически важный текст -->
      <p>© 2026 СмартОфис. Все права защищены.</p>
    </div>
    <div class="footer-contacts"> <!-- правая часть: контакты -->
      <p>Email: <a href="mailto:info@smartoffice.ru">info@smartoffice.ru</a></p>
      <!-- mailto: — открывает почтовый клиент при клике -->
      <p>Телефон: <a href="tel:+78005553535">+7 (800) 555-35-35</a></p>
      <!-- tel: — на мобильных открывает приложение звонков -->
    </div>
  </div>
</footer>
```
