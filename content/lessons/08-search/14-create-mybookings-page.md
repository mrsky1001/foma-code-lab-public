...
Пока что эта страница будет почти пустой. На ней будет только заголовок и контейнер `<div id="myBookingsList"></div>`. Мы заполним его данными в финальном Модуле 9!
