...
Мы закончили с функционалом Модуля 5!
Но перед тем как завершить, нам нужно подготовить данные для будущих модулей (где мы будем делать Личный кабинет пользователя).
...
## 🛠 Задание
В файле `js/data.js` в самом низу добавьте массив `MOCK_BOOKINGS`. И на этом модуль официально завершен!
