---
title: "Функция инициализации навигации"
highlight: js
type: practice
---
...
Выделяем логику навигации в отдельную функцию `initNavigation()` — принцип единственной ответственности.

Вызываем её внутри `DOMContentLoaded` — когда DOM готов.

Пока функция пустая — заполним следующими шагами.

## 🛠 Задание

В `DOMContentLoaded` добавьте вызов, и создайте функцию:
```js
initNavigation(); // внутри DOMContentLoaded
