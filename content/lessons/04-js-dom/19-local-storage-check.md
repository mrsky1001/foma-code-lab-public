...
`localStorage` — встроенное хранилище браузера. Данные сохраняются между перезагрузками страницы.

`localStorage.getItem('currentUser')` — возвращает строку если пользователь вошёл, или `null` если нет.

`document.getElementById('authNavBtn')` — находим кнопку авторизации в шапке.

## 🛠 Задание

Внутри updateAuthNav добавьте:
```js
// getItem возвращает строку если ключ есть, или null если нет
const currentUser = localStorage.getItem('currentUser');
// ищем кнопку «Войти» / «Выйти» в шапке по id
