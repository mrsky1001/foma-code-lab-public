---
title: "Функция updateAuthNav"
highlight: js
type: practice
---

# Функция updateAuthNav

`updateAuthNav` — функция обновления кнопки авторизации. Если пользователь вошёл — кнопка «Выйти», иначе — «Войти».

Пока пустая — наполним следующими шагами.

## 🛠 Задание

Добавьте функцию:
```js
// Функция обновления состояния кнопки входа/выхода в шапке
